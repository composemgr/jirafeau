...
- **jirafeau**: jirafeau/jirafeau:latest

## 📦 Installation

### Option 1: Quick Install
```bash
curl -q -LSsf "https://raw.githubusercontent.com/composemgr/jirafeau/main/docker-compose.yaml" -o compose.yml
```
...
```shell
docker compose logs -f jirafeau
```
